...
class BookHomeAdapter(val context: Context, private val listener: OnBookListener) :
    RecyclerView.Adapter<BookHomeAdapter.Holder>() {

    var books: List<Book> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val binding =
            ItemBookHomeBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class Holder(private val binding: ItemBookHomeBinding) :
